...
import { PeriodicElement } from 'src/modelos/PeriodicElement';
...
export class ListarArticulosComponent implements OnInit {
  ...
  editar( posicion:number ) {
    console.log("Editar registro No.: "+posicion+"*****");  
  }

  detalle( nombre:string ) {
    console.log("Ver detalle del registro: "+nombre+"*****");  
  }
...
}  //  class ListarArticulosComponent
